...
import com.mbfw.util.SpringContextUtil;
...
public class LoginController extends BaseController {
	...
	public Object login() throws Exception {
		...
		SavedRequest savedRequest = null;//WebUtils.getSavedRequest(getRequest());
		String requestUrl = null;//savedRequest==null?null:savedRequest.getRequestUrl();
		map.put("url", requestUrl==null?path.substring(1, path.length()):requestUrl);

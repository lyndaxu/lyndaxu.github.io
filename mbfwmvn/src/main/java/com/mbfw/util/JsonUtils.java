...
public class JsonUtils {
     ...
     * @return String
     */
    public static final String bean2json(Object bean) {
        StringBuilder json = new StringBuilder();
        json.append("{");
     ...
     * @return String
     */
    public static final String array2json(Object[] array) {
        StringBuilder json = new StringBuilder();
        json.append("[");
    ...
    public static final <T> T objectFromJson(String json, Class<T> klass) {
        T object;
        try {
            object = new ObjectMapper().readValue(json, klass);
     ...
     * @return String
     */
    public static final String set2json(Set<?> set) {
        StringBuilder json = new StringBuilder();
        json.append("[");

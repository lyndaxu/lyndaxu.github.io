...
//				this.$tip.css('z-index','99999').append('<iframe style="filter:alpha(opacity=0);-moz-opacity:0;position:absolute;z-index:-1" src=""></iframe>').children('iframe').width(tipW).height(this.$tip.height());
				this.$tip.bgiframe();
			} else if ($table[0]) {

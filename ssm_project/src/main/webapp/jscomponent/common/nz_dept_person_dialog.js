 ...
 * @version：    1.0
 * 程序包/文件名：    ${PACKAGE_NAME}/df_dept_person_dialog.js
 * 创建及变更历史：[格式说明：##日期/执行者\n {--删减++增加**变更}描述]
 *    TODO
 *
 *    ##2012-03-19/Alvin  创建
...
(function ($) {
    $.extend($.fn, {
        dfDeptOrPersonDialog:function (options) {
            var $this, url, urlArr = [], settings, optionDialog, defaults = {
                id:'id',
                deptUrl:'url:dfVDeptInfoAction.do?method=display', //部门选择的action
                personUrl:'url:dfVEmpInfoAction.do?method=display', //人员选择的action
                width:"800px",
                height:"500px",
                title:'部门选择',
                openAll:false, //是否全展开

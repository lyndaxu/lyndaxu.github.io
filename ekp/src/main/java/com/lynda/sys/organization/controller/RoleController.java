package com.lynda.sys.organization.controller;
...
import com.lynda.common.controller.BaseController;
...
import com.lynda.sys.organization.manager.UserManager;
...
public class RoleController extends BaseController {
	...
	public ModelAndView index(Page page){
		...
		String findContent = pd.getString("findContent".toUpperCase());
		if(StringUtils.isNotEmpty(findContent)){
			pd.put("findContent", findContent);
		}
		page.setPd(pd);
		List<URole> role = roleService.findPage(page);
		page.setList(role);

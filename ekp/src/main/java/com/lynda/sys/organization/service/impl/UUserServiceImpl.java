...
import com.lynda.core.mybatis.BaseMybatisDao;
import com.lynda.core.shiro.session.CustomSessionManager;
...
import com.lynda.sys.organization.service.UUserService;
...
public class UUserServiceImpl extends BaseMybatisDao<UUserMapper> implements UUserService {
	...
	@Override
	public List<UUser> findByPage(Page page) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<UserRoleAllocationBo> findAllUserAndRole(Page page) {
		return userMapper.findAllUserAndRole(page);
	}
